...
class BackgroundChanger(QWidget):
    def __init__(self, parent=None, label=None, change_background_func=None, background_images_path=None, button_color="#000000", background_color="#FFFFFF", font_size=12):
        ...
        button.clicked.connect(lambda: self.change_background_func(self.label, self.background_images_path))
