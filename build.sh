...
gh release create v$NEW_VERSION dist/Orange.exe --repo eusouanderson/orange_editor --title "Orange $NEW_VERSION" --notes "Release Orange $NEW_VERSION Platform: $PLATFORM"
